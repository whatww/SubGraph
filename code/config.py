...
def get_beauty_config(parser):
    ...
    parser.add_argument('--max_attended_nodes', type=int, default=25)
    parser.add_argument('--max_seen_nodes', type=int, default=100)

    parser.add_argument('--test_batch_size', type=int, default=256)
    parser.add_argument('--test_max_edges_per_example', type=int, default=100)
    parser.add_argument('--test_max_edges_per_node', type=int, default=100)
    parser.add_argument('--test_max_attended_nodes', type=int, default=25)
    parser.add_argument('--test_max_seen_nodes', type=int, default=100)
    ...
    parser.add_argument('--eval_within_epoch', default=32)
    parser.add_argument('--eval_valid', action='store_true', default=True)
...
def get_cdsVinyl_config(parser):
    parser.add_argument('--dataset', default='CDsVinyl')
    parser.add_argument('--n_dims_sm', type=int, default=50)
    parser.add_argument('--n_dims', type=int, default=100)

    parser.add_argument('--batch_size', type=int, default=256)
    parser.add_argument('--max_edges_per_example', type=int, default=200)
    parser.add_argument('--max_edges_per_node', type=int, default=100)
    parser.add_argument('--max_attended_nodes', type=int, default=25)
    parser.add_argument('--max_seen_nodes', type=int, default=200)

    parser.add_argument('--test_batch_size', type=int, default=128)
    parser.add_argument('--test_max_edges_per_example', type=int, default=200)
    parser.add_argument('--test_max_edges_per_node', type=int, default=100)
    parser.add_argument('--test_max_attended_nodes', type=int, default=25)
...
def get_default_config(name):
    ...
    if name == 'Beauty':
        return get_beauty_config(parser)
    elif name == 'FB237' or name == 'FB237_v2':
        return get_fb237_config(parser)
    elif name == 'CDsVinyl':
        return get_cdsVinyl_config(parser)
    elif name == 'FB15K':
